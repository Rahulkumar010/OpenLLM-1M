...
def get_generate_stream_function(model: torch.nn.Module, model_path: str, streaming: Optional[bool] = False):
    """Get the generate_stream function for inference."""
    if streaming:
        from fastchat.serve.streaming_inference import generate_stream
        print('Streaming..........')
    else:
